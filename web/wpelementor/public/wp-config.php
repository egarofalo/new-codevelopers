 ...
 */
define('WP_DEBUG', get_env('DEBUG', false, FILTER_VALIDATE_BOOLEAN));
define('WP_DEBUG_LOG', get_env('DEBUG_LOG', false, FILTER_VALIDATE_BOOLEAN));
define('WP_DEBUG_DISPLAY', get_env('DEBUG_DISPLAY', true, FILTER_VALIDATE_BOOLEAN));
...
/**
 * Enable FS_METHOD direct.
 */
if (get_env('FS_METHOD_DIRECT', false, FILTER_VALIDATE_BOOLEAN)) {
